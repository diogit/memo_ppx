...
[{pstr_desc =
   Pstr_value (Nonrecursive,
    [{pvb_pat = {ppat_desc = Ppat_var {txt = "t_fib"}};
      pvb_expr =
       {pexp_desc =
         Pexp_fun (Nolabel, None, {ppat_desc = Ppat_var {txt = "g"}},
          {pexp_desc =
            Pexp_fun (Nolabel, None, {ppat_desc = Ppat_var {txt = "n"}},
             {pexp_desc =
               Pexp_ifthenelse
                ({pexp_desc =
                   Pexp_apply ({pexp_desc = Pexp_ident {txt = Lident "<"}},
                    [(Nolabel, {pexp_desc = Pexp_ident {txt = Lident "n"}});
                     (Nolabel,
 ...
 {pstr_desc =
   Pstr_value (Nonrecursive,
    [{pvb_pat = {ppat_desc = Ppat_var {txt = "fib_memo"}};
      pvb_expr =
       {pexp_desc =
         Pexp_apply ({pexp_desc = Pexp_ident {txt = Lident "fix_memo"}},
          [(Nolabel, {pexp_desc = Pexp_ident {txt = Lident "t_fib"}})])}}])}]
=========
